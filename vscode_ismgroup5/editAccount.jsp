...
if (accountOnEdit == null) {
    request.setAttribute("errorMessage", "Account no: " + accountOnEdit + " not found!");
%>
...
%>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" method="POST" action="updateAccount.jsp">
						
						<!-- account number -->
						<div class="form-group">
							<label for="AccountNumber" class="col-sm-3 control-label main-label">Αριθμ. Λογ.: </label>
							<div class="col-sm-7">
							<input readonly value="<%= accountOnEdit.getAccNum() %>" type="text" name="AccountNumber" id="AccountNumber" class="form-control" placeholder="Εισάγετε τον (συντομευμένο) αριθμό του λογαριασμού" title="Εισάγετε τον αριθμό του λογαριασμού (συντομευμένη μορφή, όπως χρησιμοποιείται συχνά στο ΓΛΚ)">
							</div>
						</div>
