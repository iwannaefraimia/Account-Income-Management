...
if (incomeTypeName == null && incomeTypeALE == null) {
    throw new Exception("Δεν έχουν εισαχθεί δεδομένα σε ολα τα υποχρεωτικά πεδία, παρακαλώ συμπληρώστε ξανά στη <a href='newIncomeType.jsp'>φόρμα εισαγωγής της νέας κατηγορίας εσόδου</a>");
}
...
<head>
    ...
    <title>Omadiki5 - Αποτελέσματα εγγραφής νέας κατηγορίας εσόδου</title>
...
if (countErrors == 0) { 
  ...
  try {
    ...
    incomeTypeService.insertIncomeType(newIncomeType);
...
request.setAttribute("successMessage", "Η κατηγορία εσόδου με όνομα " + newIncomeType.getIncomeTypeName() + " καταχωρήθηκε επιτυχώς!");
%>
...
<% } %>
      ...
      <div>
        <a href="newIncomeType.jsp" class="btn btn-info btn-primary">
